  ...
  var vc3dEye = function (selectorName, params) {
    ...
    function assignOperations() {
      ...
      selector.bind("touchmove", function (target) {
        ...
        else currentX = actualTouch.pageX - this.offsetLeft;
      });
    }
    ...
    function loadAppropriateImage(newX) {
      if (currentX - newX > 25) {
        ...
        selector.css(
          "background-image",
          "url(" + imagePath + currentImage + "." + imageExtension + ")"
        );
    ...
    function initializeOverlayDiv() {
      ...
      $(selector).html(
        "<div id='VCc' style='height:100%;width:100%;' class='onLoadingDiv'>Loading...</div>"
      );
    }
