!(function (e) {
  ...
  var t = function (t, n) {
      ...
      selector.mousedown(function (e) {
        ...
        selector.bind("touchmove", function (e) {
          ...
          1 == isMoving
            ...
            : (currentX = t.pageX - this.offsetLeft);
        });
    }
    function i(e) {
      currentX - e > 25
        ? (console.log("currentX =" + currentX + " newX =" + e),
          console.log("currentX-newX=" + (currentX - e)),
          (currentX = e),
    ...
    function c() {
      ...
      selector.css("background-image", "url(" + n + ")"),
        e("<img/>")
          .attr("src", n)
          .load(function () {
            // selector.height(this.height).width(this.width);
          });
      for (var o = 2; o <= totalImages; o++)
        (n = imagePath + o + "." + imageExtension),
          selector.append("<img src='" + n + "' style='display:none;'>"),
          e("<img/>")
            .attr("src", n)
            .css("display", "none")
            .load(function () {
              t++,
                t >= totalImages &&
                  (e("#VCc").removeClass("onLoadingDiv"), e("#VCc").text(""));
            });
    }
    function r() {
      e("html").append(
    ...
    (this.selector = e(t)),
      ...
      (this.totalImages = n.totalImages),
